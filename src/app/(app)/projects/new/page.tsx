  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8">
      ...
      <Card className="bg-card/70">
        ...
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-5" id="new-project-form">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Contexto del caso, proyecto, objetivos de analisis..."
        ...
        <CardFooter className="flex items-center justify-end gap-2 border-t border-border/60">
          ...
          <Button type="submit" form="new-project-form" disabled={isSaving}>
